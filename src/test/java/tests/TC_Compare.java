...
public class TC_Compare extends BaseTest {
    ...
    public void beforeClass(String env, @Optional String browserName, @Optional String browserVersion, @Optional String os, @Optional String osVersion, String url, ITestContext context) {
        ...
        System.out.println("Thread id beforeClass TC_Compare: " + Thread.currentThread().getId() + " - " + getDriver().toString());
    }
...
//        homePage = comparePage.clickHomeMenuItem();
    ...
    public void TC_04_Add_To_Compare_Popup_5_Product() {
        ...
        Assert.assertTrue(homePage.getCompareCartWishListPopupText().replaceAll("\\s+", " ").trim().contains("Success: You have added " + fifthProductName + " to your product comparison"));
...
//    @Test
//    public void TC_05_Verify_Compare_Page_0_Product() {
//
//    }
...
//
    ...
    public void TC_08_Compare_Page_5_Product() {
        int firstProductIdInCollectionPopular = homePage.getProductIdInCollectionPopular(1);
        int fifthProductIdInCollectionPopular = homePage.getProductIdInCollectionPopular(5);
...
//    @Test
//    public void TC_19_Compare_Page_Add_To_Cart() {
//        //chọn loại product add to cart directly
//
//    }
...
//        Assert.assertEquals(comparePage.getProductIdInAddToCartPopup(),productId);
    ...
    /// /
    /// /    @Test
    /// /    public void TC__Compare_Page_Add_To_Cart_Close_Popup() {
    /// /        // Add to compare from Home page - Collection section
    /// /        //Go to compare page
    /// /        // Add to cart 1 product -> verify Add to cart popup displayed and info
    /// /        // close popup
    /// /
    /// /    }
