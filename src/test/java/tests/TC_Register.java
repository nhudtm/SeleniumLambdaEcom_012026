...
public class TC_Register extends BaseTest {
    ...
    public void TC_01_Register_Blank_Data() {
        ...
        Assert.assertEquals(registerPO.getErrorMessage("First Name"),
        ...
        Assert.assertTrue(
                registerPO.getPrivacyPolicyErrorMessage().contains("Warning: You must agree to the Privacy Policy!"));
    }

    @Description("Register to system with First Name blank/ over max")
    @Story("Register")
    @Severity(SeverityLevel.CRITICAL)
    @Test
    ...
    @Description("Register to system with First Name over max")
    @Story("Register")
    @Severity(SeverityLevel.CRITICAL)
    @Test
    ...
    @Description("Register to system with Last Name blank")
    @Story("Register")
    @Severity(SeverityLevel.CRITICAL)
    @Test
    ...
    public void TC_04_Register_Email_Invalid_01() {
        ...
        registerPO.clickToContinueButtonAtResigterPage();
        Assert.assertEquals(registerPO.getValidationMessageAtEmailTextbox(),
    ...
    // registerPO.clickToPrivacyPolicyCheckbox();
    // registerPO.clickToContinueButtonAtResigterPage();
    // Assert.assertEquals(registerPO.getExistedEmailErrorMessage(),"Warning: E-Mail
    // Address is already registered!");
    // }

    @Description("Register to system with Phone blank")
    @Story("Register")
    @Severity(SeverityLevel.CRITICAL)
    @Test
    ...
    @Description("Register to system with Phone over max")
    @Story("Register")
    @Severity(SeverityLevel.CRITICAL)
    @Test
    ...
    @Description("Register to system with Password over max")
    @Story("Register")
    ...
    @Description("Register to system with Password below min")
    @Story("Register")
    @Severity(SeverityLevel.NORMAL)
    @Test
    ...
    @Description("Register to system with Confirm Password blank")
    @Story("Register")
    @Severity(SeverityLevel.CRITICAL)
    @Test
    ...
    @Description("Register to system with Confirm Password not match")
    @Story("Register")
    @Severity(SeverityLevel.CRITICAL)
    @Test
    ...
    @Description("Register to system with valid information and NewsLetter No")
    @Story("Register")
    @Severity(SeverityLevel.MINOR)
    @Test
    public void TC_10_Register_Success_NewsLetter_No() {
        ...
        System.out
                .println("User info: " + firstName + " " + lastName + " - " + email + " - " + phone + " - " + password);
    ...
    @Description("Register to system with SQL Injection in UserName field")
    @Story("Register")
    @Severity(SeverityLevel.NORMAL)
    // @Test
    public void TC_14_Register_SQLInjection_UserName() {
        ...
        registerPO.clickToPrivacyPolicyCheckbox();
        registerPO.clickToContinueButtonAtResigterPage();
        System.out.println(registerPO.getRegisterSuccessMessage());
        Assert.assertTrue(
                registerPO.getRegisterSuccessMessage().contains("Warning: E-Mail Address is already registered!"));
