...
public class TC_Register_BrowserStack extends BaseTest {
    ...
    public void beforeClass(String env, @Optional String browserName, @Optional String browserVersion, @Optional String os, @Optional String osVersion, String url) {
        ...
        System.out.println("Thread ID TC_Register_BrowserStack= " + Thread.currentThread().getId() + " - " + browserName + " - " + getDriver().toString());
    }
